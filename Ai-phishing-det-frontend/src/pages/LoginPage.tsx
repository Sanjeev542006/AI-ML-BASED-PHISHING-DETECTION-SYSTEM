...
export function LoginPage() {
  ...
  return (
    <div style={{ minHeight: '100vh', display: 'grid', placeItems: 'center', background: '#080e17', padding: '20px' }}>
      <div className="card" style={{ width: '100%', maxWidth: '420px', padding: '32px', background: '#0f1c2e', border: '1px solid #162840', boxShadow: '0 16px 40px #02061750' }}>
        ...
        <p style={{ color: '#94a3b8', fontSize: '12px', marginBottom: '24px' }}>Access AI phishing detection workspace</p>
